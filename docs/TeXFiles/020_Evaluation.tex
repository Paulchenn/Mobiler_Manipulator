...
Im Gegensatz dazu konzentriert \ac{VisibilityPRM} die Knoten in den Bereichen, in denen sich keine Hindernisse befinden (siehe Abb.~\ref{fig:forest_vis}), indem nur solche Konfigurationen zum Graphen hinzugefügt werden, die die Sichtbarkeit erweitern (Guard-Nodes) oder unabhängige Komponenten verbinden (Connector-Nodes).
